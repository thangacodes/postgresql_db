...
echo "\e[1;32m Script executed at:" $(date '+%Y-%m-%d %H:%M:%S')
echo "You are working with app-service root-user to connect src (OR) dest databases. Please select based on your needs."
